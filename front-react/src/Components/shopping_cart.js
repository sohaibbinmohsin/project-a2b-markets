...
if(fst)
{
  ...
  for(let x=0; x<products.length ; x++)
  {
   ...
   arr2.push(<div style={{float:'left'}}><a href="#"><span style={{backgroundColor:'black'}}><i class="fa fa-plus" ></i></span></a><strong>1</strong><a href="#"><span style={{backgroundColor:'black'}}><i class="fa fa-minus"></i></span></a></div>)
   arr2.push(<br/>)
   arr2.push(<br/>)
   arr2.push(<br/>)
