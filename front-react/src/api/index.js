...
export const signUpVendor = (body) => API_URL.post('/vendor/signup', body)
export const verifyAccountVendor = (body) => API_URL.post('/vendor/verify-email',body)
export const forgotPassword = (body) => API_URL.post('/user/forgot-password',body)